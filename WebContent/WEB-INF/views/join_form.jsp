		...
		<div class="container">
			...
			<div class="input-group input-group-lg">
				...
				<input type="password" class="form-control"
					placeholder="User password1" aria-describedby="sizing-addon1">
			</div>
			<div class="input-group input-group-lg">
				<span class="input-group-addon" id="sizing-addon1">PW</span>
				<input type="password" class="form-control"
					placeholder="User password2" aria-describedby="sizing-addon1">
			</div>
			<div class="input-group input-group-lg">
			...
			<div class="input-group input-group-lg">
				...
				<input type="file" class="form-control" placeholder="User profile"
					aria-describedby="sizing-addon1">
					<div id="imgArea"></div>
			</div>
