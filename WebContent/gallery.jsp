	...
	<div class="container">
		<div class="header-left grid">
			<div class="grid__item color-1">
				<h1><a href="index.jsp"><i></i><span class="link link--kukuri" data-letters="Pets Love">Pets Love</span></a></h1>
			</div>
		</div>
				  ...
				  <div class="container-fluid">
					...
					<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
					  <ul class="nav navbar-nav menu__list">
						...
						<li class=" menu__item menu__item--current"><a class="menu__link" href="gallery.jsp">Gallery</a></li>
			...
			<section>
				<ul class="lb-album ">
					...
					<li class="grid">
						<a href="#image-10">
							<figure class="effect-apollo">
								<img src="images/g10.jpg" alt="image10">
								<figcaption>
								</figcaption>			
							</figure>
						</a>
					...
					<li class="grid">
						<a href="#image-11">
							<figure class="effect-apollo">
								<img src="images/g11.jpg" alt="image11">
								<figcaption>
								</figcaption>			
							</figure>
						</a>
					...
					<li class="grid">
						<a href="#image-12">
							<figure class="effect-apollo">
								<img src="images/g12.jpg" alt="image12">
								<figcaption>
								</figcaption>			
							</figure>
						</a>
